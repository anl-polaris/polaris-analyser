...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/polaris/icons/save.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSave.setIcon(icon1)
        self.actionSave.setObjectName(_fromUtf8("actionSave"))
        self.actionOpen = QtGui.QAction(MainWindow)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/polaris/icons/project-open-3.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionOpen.setIcon(icon2)
        self.actionOpen.setObjectName(_fromUtf8("actionOpen"))
        self.actionExit = QtGui.QAction(MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/polaris/icons/system-log-out.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/polaris/icons/system-reboot-2.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/polaris/icons/news-subscribe-2.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAdd_Data_Item.setIcon(icon5)
        self.actionAdd_Data_Item.setObjectName(_fromUtf8("actionAdd_Data_Item"))
        self.actionRefresh_Tree = QtGui.QAction(MainWindow)
        self.actionRefresh_Tree.setObjectName(_fromUtf8("actionRefresh_Tree"))
        ...
        self.menuProject.addAction(self.actionRefresh_Tree)
        self.menubar.addAction(self.menuFile.menuAction())
        self.menubar.addAction(self.menuProject.menuAction())
        self.toolBar.addAction(self.actionOpen)
        self.toolBar.addAction(self.actionSave)
        self.toolBar.addAction(self.actionAdd_Data_Item)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionRefresh_Tree.setText(_translate("MainWindow", "Refresh Tree", None))
